...
const portfolioCloseBtns = document.querySelectorAll(".portfolio-close-btn"); // Corrected variable name
...
window.addEventListener("scroll", () => {
    const sections = document.querySelectorAll("section"); // Use querySelectorAll to get all sections
...
const navItems = document.querySelectorAll(".nav-items a"); // Select all navigation links
